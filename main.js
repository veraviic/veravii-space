...
function setupGalleryNavigation() {
  ...
  const fallbackGalleryImages = [
    ...
    { src: "decoimg/droom-calculator.png", name: "Calculator" },
    { src: "decoimg/droom-candy.png", name: "Candy" },
    { src: "decoimg/droom-clock.png", name: "Clock" },
    { src: "decoimg/droom-colorpen.png", name: "Color Pen" },
    { src: "decoimg/droom-colorrefill.png", name: "Color Refill" },
    { src: "decoimg/droom-conanbakerstr.png", name: "Conan Baker Street" },
    { src: "decoimg/droom-conanbooks.png", name: "Conan Books" },
    { src: "decoimg/droom-eraser.png", name: "Eraser" },
    { src: "decoimg/droom-fishingtoy.png", name: "Fishing Toy" },
    { src: "decoimg/droom-hualushui.png", name: "Hualushui" },
    { src: "decoimg/droom-huamao.png", name: "Huamao" },
    { src: "decoimg/droom-kfcconsole.png", name: "KFC Console" },
    { src: "decoimg/droom-lotion.png", name: "Lotion" },
    { src: "decoimg/droom-med.png", name: "Medicine" },
    { src: "decoimg/droom-mole2.png", name: "Mole" },
    { src: "decoimg/droom-pokefind.png", name: "Poke Find" },
    { src: "decoimg/droom-shoe.png", name: "Shoe" },
    { src: "decoimg/droom-shuihaizi.png", name: "Shuihaizi" },
    { src: "decoimg/droom-sticker.png", name: "Sticker" },
    { src: "decoimg/droom-talesbook.png", name: "Tales Book" },
    { src: "decoimg/droom-xuanfeng.png", name: "Xuanfeng" },
    { src: "decoimg/droom-xhd1.png", name: "Detective Card" },
  ];
