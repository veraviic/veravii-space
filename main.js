...
function setupGalleryNavigation() {
  ...
  const fallbackGalleryImages = [
    { src: "decoimg/droom-hualushui.png", name: "花露水" },
    { src: "decoimg/droom-calculator.png", name: "计算器型计算机" },
    { src: "decoimg/droom-candy.png", name: "胶质糖果" },
    { src: "decoimg/droom-clock.png", name: "闹钟" },
    { src: "decoimg/droom-colorpen.png", name: "水彩笔" },
    { src: "decoimg/droom-colorrefill.png", name: "水彩笔补充液" },
    { src: "decoimg/droom-conanbakerstr.png", name: "柯南剧场版：贝克街的亡灵" },
    { src: "decoimg/droom-conanbooks.png", name: "柯南漫画书" },
    { src: "decoimg/droom-eraser.png", name: "橡皮擦" },
    { src: "decoimg/droom-fishingtoy.png", name: "钓鱼玩具" },
    { src: "decoimg/droom-blockingtoy.png", name: "积木玩具" },
    { src: "decoimg/droom-huamao.png", name: "花猫侦探：寻物绘本" },
    { src: "decoimg/droom-kfcconsole.png", name: "KFC上校游戏机" },
    { src: "decoimg/droom-lotion.png", name: "劳动护肤霜" },
    { src: "decoimg/droom-med.png", name: "葡萄糖酸锌口服液" },
    { src: "decoimg/droom-mole2.png", name: "鼹鼠的故事" },
    { src: "decoimg/droom-pokefind.png", name: "宝可梦寻物绘本" },
    { src: "decoimg/droom-shoe.png", name: "小白体操鞋" },
    { src: "decoimg/droom-shuihaizi.png", name: "水孩子" },
    { src: "decoimg/droom-sticker.png", name: "换装贴纸" },
    { src: "decoimg/droom-talesbook.png", name: "《影响中国孩子的100个童话》" },
    { src: "decoimg/droom-xuanfeng.png", name: "四驱玩具车" },
    { src: "decoimg/droom-xhd1.png", name: "冒险小虎队" },
  ];
  ...
  function updateDescriptionPanel(imageData, index) {
    ...
    if (descType) descType.textContent = "图像（jpg./png.格式)";
  ...
  const itemDescriptionsByFile = {
    "droom-blockingtoy.png": "我最喜欢拱形的那对积木，它们摸起来很光滑。",
    "droom-calculator.png": "每次玩计算器的时候，我都在幻想着它们是我的电脑。",
    "droom-candy.png": "长条的彩色糖不同颜色会有不同的味道，感觉买一袋吃到好几个味道很赚。",
    "droom-clock.png":
      "每天早晨它都会大声嚷着“起床懒猪”，但其实真正能叫醒我的，其实是妈妈和她放着的英文磁带。",
    "droom-colorpen.png": "喜欢在每只彩笔笔尾的盖章，但是它们很费笔水，我总是边用边担心。",
    "droom-colorrefill.png": "每次用墨水补给彩笔，我总是灌补进去，反而是弄脏手，染在虎口一片。",
    "droom-conanbakerstr.png":
      "最喜欢的柯南剧场版，是老郝给我在家对面亭子旁边的杂志亭买的，为了骗我老实把中药都喝完。",
    "droom-conanbooks.png": "只有黑衣人集合的那一大厚本合集是最好看的。",
    "droom-eraser.png":
      "我有一大堆橡皮。可能我喜欢文具的原因，是因为它们看起来是最合理购入的玩具吧。",
    "droom-fishingtoy.png":
      "鱼竿和鱼是用磁铁吸在一起的，所以并不是每一次钓都可以钓上来，转盘还会变速。",
    "droom-hualushui.png":
      "这些都是夏天的味道。除了在蚊子咬的地方画十字，抹一些这些驱蚊清凉的还是多少有用的。",
    "droom-huamao.png":
      "这个系列的图画书都很好看，里面的小动物画的都很生动，在里面找小动物还能看很多好笑的互动和小故事。",
    "droom-kfcconsole.png":
      "我最喜欢拿上校游戏机玩俄罗斯方块，但是游戏机好像在搬家的时候丢掉了。里面有很多差不多玩法的游戏，我最常玩的。。可能也就5个左右？",
    "droom-lotion.png":
      "在姥姥家过夜总拿这个擦脸；用完脸不干很润，还不油腻。比起万紫千红霜更好闻。",
    "droom-med.png":
      "以前我总不喜欢吃饭，妈妈就一直觉得需要给我补锌。我感觉喝这个并没有让我食欲更好，虽然是药但是喝久了很像在喝饮料。",
    "droom-mole2.png": "小鼹鼠，小老鼠和大耳朵兔子我都喜欢。我和妈妈最喜欢小鼹鼠咯咯咯的笑声。",
    "droom-pokefind.png":
      "又是一本最爱看的找寻物品和动物的图画书。小时候有段时间很迷宝可梦和相关的周边。",
    "droom-shoe.png":
      "每一次我新穿一双小白体操鞋，总会有人一脚踩一个脚印在我的鞋上，就像被注定、被‘诅咒’了一样。",
    "droom-shuihaizi.png": "爸爸妈妈在美特好给我买的，特别喜欢里面配的插图。",
    "droom-sticker.png":
      "我喜欢掀起衣服贴纸打扮女生贴纸。每次我都不会贴很死，这样可以掀起来多玩几次。",
    "droom-talesbook.png":
      "哪怕这本童话书很厚，我还是会把它放在枕头下面。就是在这一本里面，我了解到了最喜欢的童话故事人物——长袜子皮皮。",
    "droom-xuanfeng.png":
      "在看完四驱兄弟以后，幻想自己也像他们一样。妈妈给我买的第一个也是最后一个四驱车玩具，在雨停之后拿出去第一次玩，就一猛子扎入了水坑里面。",
    "droom-xhd1.png": "作为小朋友，我总是很好奇里面的侦探卡能帮助破案、解决谜题的原理。",
  };
